...
import "../styleResume/Resume04.css";
...
const Resume04 = () => {
  ...
  useEffect(() => {
    ...
    const experience = JSON.parse(
      localStorage.getItem("ProfessionalExperience")
    );
    ...
    if (skills && skills[0]?.skill !== "") {
      setResumeSkills(
        <div className="boxt04" id="Skillst04">
          <h3 className="titlet04" id="Skillstitlet04">
            Skills
          </h3>
          <ul className="skilllistt01">
            {skills.map((sk, index) => (
              <li className="listitemt01" key={index}>
                {sk.skill}
              </li>
            ))}
          </ul>
  ...
  const populateExperience = (experience) => {
    if (experience && experience[0]?.WorkSummary) {
      setexperienceHTML(
        <>
          <h3 className="titlet04" id="expertitlet04">
            Experience
          </h3>
          {experience.map((exp, index) => (
            <div key={index} className="experienceblock">
              ...
              <div className="durationt04">
                <span className="startdatet04">{exp.StartDate}</span>
                <span>-</span>
                <span className="lastdatet04">{exp.EndDate}</span>
              </div>
  ...
  const populateEducation = (education) => {
    if (education && education[0]?.schname) {
      seteducationHTML(
        <>
          <h3 className="titlet04" id="educationtitlet04">
            Education
          </h3>
    ...
    if (projectInfo && projectInfo[0]?.projectTitle) {
      setprojectInfoHTML(
        <div className="boxt04" id="projectt04">
          <h3 className="titlet04" id="protitt04">
            Project
          </h3>
      ...
      <div className="resumet04" ref={componentRef} id="resumet04">
        <div className="upperpartt04">
          <div className="imgcontainert04">
            <img className="userPhotot04" src={Image} alt="" />
          </div>
          <div className="fullnameAndPostt04">
            <div className="namet04">
              <span className="fullNamet04">
                {fname} {lname}
              </span>
            </div>
        ...
        <div className="lowerpartt04">
          ...
          <div className="rightsidet04">
            <div className="boxt04" id="summaryboxt04">
              <h3 className="titlet04" id="summarytitlet04">
                Summary
              </h3>

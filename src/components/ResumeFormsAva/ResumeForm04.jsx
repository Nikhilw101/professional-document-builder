...
const ResumeForm04 = () => {
    ...
    const handleNext = (e) => {
        ...
        if (validateForm()) {
            loadToLocalStorage();
            navigate("/resumeform05"); // Navigate programmatically if validation passes
        }
    };
    ...
    return (
        <>
            ...
            <div style={{ display: "flex", justifyContent: "center", marginTop: "80px", fontFamily: "kanit", marginBottom: "35vh" }}>
                <Link to="/resumeform03" className="btn btn-outline-danger" style={{ marginRight: "50px", width: "180px", fontSize: "18px" }}>Back</Link>

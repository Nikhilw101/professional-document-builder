...
import "../styleResumeAva/ResumeAva05.css"; // Make sure to create a new CSS file for ResumeAva05
          ...
          {experience.map((exp, index) => (
            <div key={index} className="experience-item">
              ...
              <div className="duration">
                <span className="start-date">{exp.StartDate}</span>
                <span>-</span>
                <span className="end-date">{exp.EndDate}</span>
              </div>
        ...
        <div className="education-section">
          ...
          <ul className="education-list">
            {education.map((edu, index) => (
              <li key={index}>
                <h4>
                  {edu.deg} in {edu.field}
                </h4>
                <div>
                  {edu.edustrdate} - {edu.eduendate}
                </div>
                <div>{edu.schname}</div>
                <div>{edu.schloc}</div>
              </li>
